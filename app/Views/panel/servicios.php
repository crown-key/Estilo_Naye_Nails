...
<div class="row">
    <div class="col-12">
        <a type="button" class="btn btn-primary" href="<?= route_to('nuevo_servicio') ?>" style="margin-bottom: 15px;">
            <i class="fas fa-lg fa-plus-circle"></i> Agregar nuevo servicio
        </a>
        <div class="card">
            <div class="border-bottom title-part-padding">
                <h4 class="card-title mb-0 text-center">Lista de servicios</h4>
            </div>
            <div class="card-body">
                     ...
                     <table class="datatable table table-striped table-bordered" style="width:100%" cellspacing="0">
                        <thead class="text-center">
                            <tr>
                                ...
                                <th class="special-cell">Precio</th>
                        ...
                        <tbody>
                            <?php
                                ...
                                foreach ($servicios as $servicio) {
                                    ...
                                    if(isset($servicio->eliminacion)){
                    					echo '<button type="button" class="btn btn-light-danger text-danger recover-servicio btn-circle" id="recover-servicio_'.$servicio->id_servicio.'" data-bs-toggle="tooltip" data-bs-placement="top" title="Recuperar el servicio">
                    							<i data-feather="rotate-ccw" class="feather fill-white"></i>
                    						  </button>';
                    				}//end if el servicio ha sido eliminado
                                    else{
                                        if(($servicio->estatus_servicio) == ESTATUS_HABILITADO)
                                            echo '<button type="button" class="btn btn-success estatus btn-circle" id="'.$servicio->id_servicio.'_'.$servicio->estatus_servicio.'" data-bs-toggle="tooltip" data-bs-placement="top" title="Deshabilitar al servicio">
                                                        <i data-feather="toggle-right" class="feather fill-white"></i>
                                                  </button>';
                                        else
                                            echo '<button type="button" class="btn btn-secondary estatus btn-circle" id="'.$servicio->id_servicio.'_'.$servicio->estatus_servicio.'" data-bs-toggle="tooltip" data-bs-placement="top" title="Habilitar al servicio">
                                                        <i data-feather="toggle-left" class="feather fill-white"></i>
                                                  </button>';
                                        echo '&nbsp;&nbsp;&nbsp;';
                                        echo '<a type="button" href="'.route_to('detalles_servicio', $servicio->id_servicio).'" class="btn btn-warning btn-circle" id="'.$servicio->id_servicio.'" data-bs-toggle="tooltip" data-bs-placement="top" title="Editar al servicio">
                                                    <i data-feather="edit-3" class="feather fill-white"></i>
                                              </a>';
                                        echo '&nbsp;&nbsp;&nbsp;';
                                        echo '<button type="button" class="btn btn-danger eliminar-servicio btn-circle" id="'.$servicio->id_servicio.'" data-bs-toggle="tooltip" data-bs-placement="top" title="Eliminar al servicio">
                                                    <i data-feather="trash-2" class="feather fill-white"></i>
                                              </button>';
                                    }//end else el servicio ha sido eliminado
                                    echo '</td>';
                                    echo '</tr>';
...
<?= $this->section("js") ?>
    ...
    <!-- JS específico -->
    <script src="<?php echo base_url(RECURSOS_PANEL_JS."/specifics/servicios.js") ?>"></script>
<?= $this->endSection(); ?>
