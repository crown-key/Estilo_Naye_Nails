    ...
    <div class="max-w-4xl mx-auto my-16  px-6 py-2 rounded-lg bg-white">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
            ...
            <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300">
                <img class="h-48 w-full object-cover rounded-t-lg" src="<?= base_url(RECURSOS_IMG . '/lavar_pies.jpg') ?>" alt="Afecciones de los pies">
            ...
            <!-- Paso 2 -->
            <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300">
                <img class="h-48 w-full object-cover rounded-t-lg" src="<?= base_url(RECURSOS_IMG . '/secar_pies.jpg') ?>" alt="Callosidades">
            ...
            <!-- Paso 3 -->
            <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300">
                <img class="h-48 w-full object-cover rounded-t-lg" src="<?= base_url(RECURSOS_IMG . '/cortar_uñas.jpg') ?>" alt="Uñas encarnadas">
            ...
            <!-- Paso 4 -->
            <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300">
                <img class="h-48 w-full object-cover rounded-t-lg" src="<?= base_url(RECURSOS_IMG . '/limar_uñas.jpg') ?>" alt="Infecciones por hongos">
                <h3 class="text-xl font-semibold text-center text-letra mt-4">4. Limarlas correctamente para darles una forma adecuada.</h3>
            </div>

            <!-- Paso 5 -->
            <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300">
                <img class="h-48 w-full object-cover rounded-t-lg" src="<?= base_url(RECURSOS_IMG . '/aplicar_crema.jpg') ?>" alt="Enfermedades del pie">
            ...
            <!-- Paso 6 -->
            <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300">
                <img class="h-48 w-full object-cover rounded-t-lg" src="<?= base_url(RECURSOS_IMG . '/calzado_comodo.jpg') ?>" alt="Lesiones leves">
            ...
            <!-- Paso 7 -->
            <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300">
                <img class="h-48 w-full object-cover rounded-t-lg" src="<?= base_url(RECURSOS_IMG . '/especialista.jpg') ?>" alt="Recuperación de salud">
